...
class Brainz:
    def __init__(self, cache_dir):
        ...
        mus.set_useragent(
            "python-pidi-dan: A cover art daemon.",
            __version__,
            "https://github.com/DanOrsborne/mopidy-pidi",
        )
    ...
    def request_album_art(self, artist, album, size=500, retry_delay=5, retries=5):
        ...
        try:
            ...
            logger.info("mopidy-pidi-dan: musicbrainz using release-id: {release_id}")
            ...
            if retries == 0:
                ...
                return None
            logger.info(
                f"mopidy-pidi-dan: musicbrainz retrying download. {retries} retries left!"
            )
            ...
            logger.info(
                f"mopidy-pidi-dan: musicbrainz couldn't find album art for {artist} - {album}"
            )
            return None
